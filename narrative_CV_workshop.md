...
- Module one: explain contributions to generation of new ideas, tools, methodologies or knowledge
...
- explain your contributions to the geenration of new ideas, tools, methodologies or knowledge

- how you communicate  your ideas and results

- key outputs: sich as data sets, software, research and policy publications

- skills acquired from past research

- software for privacy preserving analysis so that can data analysis can be done on patient data while respecting the privacy of patients

- patient workshops explain AI 

- involve patients in AI model building. This led to 2 high impact papers. Highly cited
...
- skills: learnt how to work with different stakeholders, e.g. clinicians, patients, supply chain experts. I have learnt to work productively and really engage with and immerse myself in the works and problems of different experts in different domains. For example, Cell Biology [An excitable Rho GTPase signaling network generates dynamic subcellular contraction patterns, Melanie Graessl, Johannes Koch, Abram Calderon, Dominic Kamps, Soumya Banerjee, Tomáš Mazel, Nina Schulze, Jana Kathrin Jungkurth, Rutuja Patwardhan, Djamschid Solouk, Nico Hampe, Bernd Hoffmann, Leif Dehmelt, Perihan Nalbant. Journal of Cell Biology 216(12), 4271-4285, 2017], immunology [Deconvolution of monocyte responses in inflammatory bowel disease reveals an IL-1 cytokine network that regulates IL-23 in genetic and acquired IL-10 resistance Gut, 2020 (British Medical Journal publishing group, Impact Factor = 19.8], this collaboration with 

- evidence based

## Module 2: contributions 

- explain your contributions to the development of others and maintenance of effective wo0rking relationships

- expertise you provided 

- I mentored wet-lab experimental biologists, taught them about computer modelling and encouraged them to stay in science and do post-graduate studies

- teaching activities, workshops a dnd mentoring

I taught patients and the lay audience about AI

- leadership in shaping direction of team 

I took leadership of a team of AI researchers, postdocs, students, HPC people, clinicians and developed a clinical informatics  and we together developed AI tools for privacy preserving analysis of patient data. 

gut paper

- approached for help reviewing grants about patient and public involvement in AI research in UKRI


## Module 3

- explain your contibutions to wider research and innovation community

- positions of responsibiity

- committemnts sich as reviewing, editing and committe work

- strategic leadership in inflouencing a research agenda

- not just list of journals but how I shaped the research agenda

 - I take great repsonsbility in ensuring papers have scientific rigour. I also care a lot about reprducibility. Whenever I review papers I insist that github repos are made available and data is shared (if possible). I think this is very important for moving science forward. 
 
 - I thoroighly review papers in Frontiers journals and Artificial Life journal. I also review for journals from countries where science is currently underfunded (such as Croatia).

 - dont just make it a list of journals. Have narrative


## Module 4: Impact

- explain your contributions to broader research or innovation users and audiences and towards wider societal impact
- how you have engaged with public sector, clients and wider public

- research contributed  to public understanding

- research contributed to policy development


- podcast and videos I have done on YouTube on AI and demystifying it for the public. YouTube channel: AI and us with Soumya Banerjee. 

- research for STEM for minorities and other outreach. getting minorities interested in STEM. Women in STEM.

- work in schools and getting students intrerested in AI. work in rural India, work in colleges in India getting students who are underprivileged and teaching them AI and getting them interested in research.

- I supported one of my students 


## Things to keep in mind


- Dont just make it a list of journals. Have a narrative

- explain why I am 13 years post-PhD. Unconventional career path. Worked in lots of domains. Contributed to my understanding of the key problems and common problems faced by different disciplines. A unique perspective on AI that is informed by biology.


## Links to CV and other material

- [CV](https://github.com/neelsoumya/CV/blob/master/CV_SoumyaBanerjee.pdf)

- Here is my detailed CV in .md format:

A short version of my CV and some previous responses to selection criterion is here: # Soumya Banerjee
...
### Senior Lecturer  
**University of York, UK** (2026-till present)  
...
- Teach introduction to machine learning, data science, reproducibility, and data visualization at University of Cambridge.  
...
My teaching materials and practical guides are used by students and colleagues and are publicly available:
https://sites.google.com/site/neelsoumya/teaching
An example course I developed is available here:
